# Carbon copy from LHE reader in geeksw:
# https://github.com/guitargeek/geeksw/blob/master/geeksw/lhe/LHEReader.py
# Note to self: try to not let it diverge too much
